...
a1, y1, e1 = eq.one_layer( L_01, L_12, centerpos1, delta_a_j, beta1)
...
a2, y2, e2 = eq.two_layers( L_01, L_12,L_23, centerpos1, centerpos2, 
...
def sliders_on_changed(val):
    ...
    a1, y1, e1 = eq.one_layer( L01_slider.val, L12_slider.val, centerpos1, 
        delta_a_j, beta1)
    ...
    line1.set_ydata(y1)
    ax1.set_ylim(0, 1)
    a2, y2, e2 = eq.two_layers( L01_slider.val, L12_slider.val, 
